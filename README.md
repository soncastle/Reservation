...
- Front
  ...
  - 유지보수성
    ...
    - redux.tulkit을 통해 분산되어 있던 세션 관련 로직을 통합하여 프로젝트 내 인증 상태 관리의 일관성과 유지보수성 확보
  - 사용자 편의성
...
-----------------
### 수정 및 개발중인 기능
- redux.tulkit 적용 후 및 데이터 반환 관련 문제 수정중
...
- Front
  - Redux Toolkit
    - 세션 체크, 로그인 상태, 사용자 정보를 통합된 전역 상태로 관리하도록 구조를 일원화
